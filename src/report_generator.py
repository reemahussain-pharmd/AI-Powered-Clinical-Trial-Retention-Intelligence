...
class RetentionReport(FPDF):
    ...
    def draw_risk_gauge(self, risk_pct: int):
        ...
        segments = [
            ("LOW",      "0-30%",    GREEN_RISK),
            ("MODERATE", "31-60%",   AMBER_RISK),
            ("HIGH",     "61-80%",   ORANGE_RISK),
            ("CRITICAL", "81-100%",  RED_RISK),
        ]
        for label, _rng, color in segments:
        ...
        "evidence": [
            {
                ...
                "evidence": {
                    ...
                    "recommendation": (
                        "Trial sponsors should consider transportation reimbursement as a standard retention "
                        "strategy for participants residing more than 50 km from trial sites."
                    ),
                },
            },
            {
                ...
                "evidence": {
                    ...
                    "evidence": "Proactive safety monitoring is mandated for early-phase trials to protect participant welfare.",
                    "recommendation": (
        ...
        "top_scenarios": [
            {
                ...
                "interpretation":   "Adding transportation support may reduce dropout risk from 94% to approximately 76% (estimated reduction: 18.2 percentage points).",
                "original_risk":    0.94,
                "new_risk":         0.76,
            ...
            },
            {
                ...
                "interpretation":   "Implementing weekly safety calls may reduce dropout risk from 94% to approximately 80% (estimated reduction: 14.0 percentage points).",
                "original_risk":    0.94,
                "new_risk":         0.80,
